  ...
  <div>
    <form onSubmit={handleSubmit}>
      <label>
        ...
        <input type="text" name="firstName" defaultValue={firstName} placeholder="First Name" onChange={handleChange} />
        <input type="text" name="lastName" defaultValue={lastName} placeholder="Last Name" onChange={handleChange} />
      </label>
